...
// carries its own Id/TenantId and ErpDbContext.SaveChanges reads them from there.
...
// Implemented in Erp.Infrastructure (handlers need ErpDbContext). tenantId is passed
