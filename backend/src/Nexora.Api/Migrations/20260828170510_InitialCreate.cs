        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WasDenied = table.Column<bool>(type: "bit", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_TenantId_IsDeleted",
                table: "AuditLogs",
                columns: new[] { "TenantId", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_Departments_TenantId_IsDeleted",
                table: "Departments",
                columns: new[] { "TenantId", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAssignmentHistories_TenantId_IsDeleted",
                table: "EmployeeAssignmentHistories",
                columns: new[] { "TenantId", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_Employees_TenantId_IsDeleted",
                table: "Employees",
                columns: new[] { "TenantId", "IsDeleted" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Locations_TenantId_IsDeleted",
                table: "Locations",
                columns: new[] { "TenantId", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_RolePermissions_TenantId_IsDeleted",
