...
public abstract class TenantEntity
{
    ...
    // Not persisted (see DbContext.OnModelCreating, which .Ignore()s this for every
    // TenantEntity subtype) — a transient in-memory queue an aggregate fills via
    // AddDomainEvent while its properties are being changed. DbContext.SaveChanges reads
