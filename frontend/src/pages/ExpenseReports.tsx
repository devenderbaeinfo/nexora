...
export default function ExpenseReports() {
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => (await api.get<ExpenseReportRow[]>("/reports/expenses")).data,
  });
    ...
    <div>
      <header style={s.header}>
        <div>
          ...
          <p style={s.subtitle}>Reimbursements and project expenses by category, for your team and managed projects.</p>
        </div>
      </header>
